<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEmployee.Master" AutoEventWireup="true" CodeBehind="modifyDomesticRequests.aspx.cs" Inherits="TravelDesk.Employee.modifyDomesticRequests" %>
                                        ...
                                        <!--END OF FLIGHT INFORMATION-->
                                                            ...
                                                            <div class="card-block" id="uploadBlock" runat="server">
                                                               ...
                                                               <asp:FileUpload ID="employeeUpload" type="file" runat="server" CssClass="auto-style12" Width="348px" />
                                                                <asp:Button class="form-control btn btn-primary btn-sm"  ID="Button1" runat="server" Text="Upload" OnClick="uploadNew_Click" Width="150px" style="margin-left:10px" CausesValidation="False" />
                                                                ...
                                                                <div class="col-md-5" style="display:none" id="pdfBlock" runat="server">
                                                                  <asp:Label ID="Label17" runat="server" Text="Manager Email Approval"></asp:Label>     <br />  <br />                                                           
                                                                        <asp:Button runat="server" class="btn btn-danger" Text="Delete" ID="Delete"  CausesValidation="False" /> 
                                                                    <br /> <br />
                                                            ...
                                                            <div class="card-block">
                                                             ...
                                                             <asp:Button runat="server" class="btn btn-primary" Text="Submit" ID="submitRequestbtn" OnClick="saveChanges_Click"/>
                                                             <asp:Button runat="server" class="btn btn-primary" Text="Save as Draft" ID="saveAsDraft" OnClientClick = "disableValidators();" />
