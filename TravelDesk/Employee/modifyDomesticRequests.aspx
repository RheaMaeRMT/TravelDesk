                                                ...
                                                <div class="card" style="color:black;">
                                                    <div class="card-header" style="background-color:#09426a">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="card-block" id="uploadBlock">
                                                                 <asp:Label ID="Label20" runat="server" Text="Upload new proof"></asp:Label> <br />
                                                                <asp:FileUpload ID="employeeUpload" type="file" runat="server" CssClass="auto-style12" Width="348px" />
                                                                <asp:Button class="form-control btn btn-primary btn-sm"  ID="uploadNew" runat="server" Text="Upload" OnClick="uploadNew_Click" Width="150px" style="margin-left:10px" CausesValidation="False" />
                                                            ...
                                                            <div class="card-block">
                                                             <asp:Button runat="server" class="btn btn-primary" Text="Save Changes" ID="saveChanges" OnClick="saveChanges_Click" />
