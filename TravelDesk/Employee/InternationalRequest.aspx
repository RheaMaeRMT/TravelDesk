                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-12 col-xl-6">
                                                                                                 <div class="card-block" id="uploadPassport" runat="server">
                                                                                                   ...
                                                                                                   <asp:FileUpload ID="passportUpload" type="file" runat="server" CssClass="auto-style12" Width="348px" />
                                                                                                    <asp:Button class="form-control btn btn-primary btn-sm"  ID="uploadPassportbtn" runat="server" Text="Upload" OnClick="uploadPassportbtn_Click" Width="150px" style="margin-left:10px" CausesValidation="False" />
<%--                                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" CssClass="required" ControlToValidate="passportUpload"></asp:RequiredFieldValidator>--%>
                                                                                                 ...
                                                                                                 <div class="col-md-5" style="display:none" id="passportBlock" runat="server">
                                                                                                  <asp:Label ID="Label25" runat="server" Text="Copy of Passport"></asp:Label>     <br />  <br />                                                           
                                                                                                        <asp:Button runat="server" class="btn btn-danger" Text="Delete" ID="passportReupload" OnClick="passportReupload_Click" CausesValidation="False" /> 
                                                                                                    <br /> <br />
