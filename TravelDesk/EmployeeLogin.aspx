<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeLogin.aspx.cs" Inherits="TravelDesk.EmployeeLogin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Travel Desk | Employee Login</title>
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <a href="Employee/EmployeeDashboard.aspx" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20"> Log in</a>
<%--                                            <button type="button" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Sign in</button>--%>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <p class="text-inverse text-left"><i class="ti-angle-left"></i> <a href="LandingPage.aspx"><b>Back</b></a></p>
                                        </div>
                                        <div class="col-md-2">
