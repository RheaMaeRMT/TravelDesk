    ...
    public partial class VisaApplication : System.Web.UI.Page
    {
        ...
        private void DisplayRequest()
        {
            ...
            if (!string.IsNullOrEmpty(status) && (!string.IsNullOrEmpty(userID)))
            {
                ...
                string query = "SELECT visaReqStatus, visaReqID, visaFname + ' ' + ISNULL(visaMname, '') + ' ' + visaLname AS FullName, visaPurpose, visaDestination, visaEstTravelDate, visaDU, visaBdate, visaEmail, visaLevel, visaReqCreated FROM travelVisa WHERE visaReqStatus = @Status";
