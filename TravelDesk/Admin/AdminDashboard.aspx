                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card" style="background-color:#09426a">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <asp:Button runat="server" ID="visaPending" OnClick="approved_Click" CssClass=" h4" BorderStyle="None" BackColor="Transparent"/> <br />
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card" style="background-color:#09426a">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <asp:Button runat="server" ID="visaProcessing" OnClick="approved_Click" CssClass="h4" BorderStyle="None" BackColor="Transparent"/> <br />
<%--                                                                <asp:Label ID="processing" runat="server" class="text-c-purple h4"></asp:Label> <br />--%>
                                                                <a class=" m-b-0">Processing Requests</a>
                                                            </div>
                                                            <div class="col-4 text-right">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card" style="background-color:#09426a">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <asp:Button runat="server" ID="visaCompleted" OnClick="approved_Click" CssClass="h4" BorderStyle="None" BackColor="Transparent"/> <br />
<%--                                                                <asp:Label ID="completed" runat="server" class="text-c-purple h4"></asp:Label> <br />--%>
                                                                <a class=" m-b-0">Completed Requests</a>
                                                            </div>
                                                            <div class="col-4 text-right">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card" style="background-color:#09426a">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <asp:Button runat="server" ID="visaGranted" OnClick="approved_Click" CssClass=" h4" BorderStyle="None" BackColor="Transparent"/> <br />
<%--                                                                <asp:Label ID="cancelled" runat="server" class="text-c-purple h4"></asp:Label> <br />--%>
